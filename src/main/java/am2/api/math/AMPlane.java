...
public class AMPlane {
	...
	public boolean lineSegmentCrosses(AMVector3 p1, AMVector3 p2) {
		...
		return !(distance1 * distance2 >= 0);                        // Return false if each point has the same sign.  -1 and 1 would mean each point is on either side of the plane.  -1 -2 or 3 4 wouldn't...
