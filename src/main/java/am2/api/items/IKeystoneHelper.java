...
public interface IKeystoneHelper {
	 ...
	 */
	ArrayList<Long> GetKeysInInvenory(EntityLivingBase ent);
	...
	/**
	 ...
	 @return
	 */
	long getKeyFromRunes(ItemStack[] runes);
	 ...
	 */
	boolean canPlayerAccess(IKeystoneLockable inventory, EntityPlayer player, KeystoneAccessType accessMode);
}
