...
public class ItemAffinityBook extends ArsMagicaItem {
	...
	public String getItemStackDisplayName(ItemStack par1ItemStack) {
		...
		if(affinity == null) {
			return StatCollector.translateToLocal("item.arsmagica2:affinityTome.name");
		}

		return StatCollector.translateToLocal("item.arsmagica2:affinityTome.name") + ": " + affinity;
	}
