...
public class EntityFireGuardian extends AM2Boss {
		...
		if(par1DamageSource.isFireDamage()) {
			...
			if(this.worldObj.isRemote) {
				...
				if(particle != null) {
					...
					particle.AddParticleController(new ParticleOrbitEntity(particle, this, 0.5f, 2, false).setIgnoreYCoordinate(true)
	...
	protected void dropFewItems(boolean par1, int par2) {
		...
		for(int j = 0; j < i; j++) {
			this.entityDropItem(new ItemStack(ItemsCommonProxy.essence, 1, ItemEssence.META_FIRE), 0.0f);
		}
