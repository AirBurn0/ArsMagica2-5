...
public class ContainerObelisk extends Container {
	...
	private final int INVENTORY_STORAGE_START = 0;
	private final int PLAYER_INVENTORY_START = 1;
	private final int PLAYER_ACTION_BAR_START = 28;
	private final int PLAYER_ACTION_BAR_END = 37;
