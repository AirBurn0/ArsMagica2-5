...
public class MeteorSpawnHelper {
	...
	public void spawnMeteor() {
		...
		if(time > 14500 && time < 21500) { //night time range (just past dusk and just before dawn)
			...
			for(int i = 0; i < 10; ++i) {
				AMVector3 offsetCoord = spawnCoord.copy()
												  .add(new AMVector3(rand.nextInt(meteorOffsetRadius) - (meteorOffsetRadius / 2), 0, rand.nextInt(meteorOffsetRadius) - (meteorOffsetRadius / 2)));
