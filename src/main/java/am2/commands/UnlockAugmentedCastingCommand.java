...
public class UnlockAugmentedCastingCommand extends CommandBase {
	...
	public void processCommand(ICommandSender var1, String[] var2) {
		...
		SkillData.For(player)
				 .learn(SkillManager.instance.getSkill("AugmentedCasting").getID() + SkillManager.TALENT_OFFSET, 3);
		SkillData.For(player).forceSync();

		func_152373_a(var1, this, "Unlocking augmented casting for " + player.getCommandSenderName());
	}
}
