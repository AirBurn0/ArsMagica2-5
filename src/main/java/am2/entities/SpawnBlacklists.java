...
public class SpawnBlacklists {
	private static final ArrayListMultimap<Integer, Class> blacklistedDimensionSpawns = ArrayListMultimap.create();
	private static final ArrayListMultimap<Integer, Class> blacklistedBiomeSpawns = ArrayListMultimap.create();
	private static final ArrayList<Integer> blacklistedWorldgenDimensions = new ArrayList<Integer>();
	private static final ArrayList<Class> progenyBlacklist = new ArrayList<Class>();
	private static final ArrayList<Class> butcheryBlacklist = new ArrayList<Class>();
