...
public class EntityDarkMage extends EntityMob {
	...
	private static final ItemStack diminishedHeldItem = new ItemStack(ItemsCommonProxy.bookAffinity, 1, 6);
	private static final ItemStack normalHeldItem = new ItemStack(ItemsCommonProxy.bookAffinity, 1, 3);
	private static final ItemStack augmentedHeldItem = new ItemStack(ItemsCommonProxy.bookAffinity, 1, 0);
