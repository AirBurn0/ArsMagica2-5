...
public class EntityBroom extends EntityCreature {
	...
	private final EntityBroomInventory inventory;
		...
		if(worldObj.isRemote) {
			...
			if(isMoving()) {
				...
				if(particle != null) {
					...
					particle.AddParticleController(new ParticleFadeOut(particle, 1, false).setFadeSpeed(0.03f)
	...
	protected boolean interact(EntityPlayer par1EntityPlayer) {
		if(par1EntityPlayer.getCurrentEquippedItem() != null && par1EntityPlayer.getCurrentEquippedItem()
