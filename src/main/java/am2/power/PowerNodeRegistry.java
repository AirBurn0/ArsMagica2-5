...
public class PowerNodeRegistry {
	...
	private final TreeMap<ChunkCoordIntPair, HashMap<AMVector3, PowerNodeEntry>> powerNodes;
	...
	private ChunkCoordIntPair getChunkFromNode(IPowerNode node) {
		...
		if(!te.getWorldObj()
			  .checkChunksExist(te.xCoord, 0, te.zCoord, te.xCoord, te.getWorldObj().getActualHeight(), te.zCoord)) {
