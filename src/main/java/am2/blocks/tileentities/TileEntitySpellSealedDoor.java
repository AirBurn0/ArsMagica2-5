...
public class TileEntitySpellSealedDoor extends TileEntity implements IInventory, IKeystoneLockable {
	...
	private final int opentime = 40;

	private final ArrayList<ISpellComponent> appliedParts;
	private final ArrayList<ISpellComponent> key;
	...
	public void analyzeSpellForKey() {
		...
		for(int i = 0; i < stages; ++i) {
			...
			Collections.addAll(key, components);
		}
