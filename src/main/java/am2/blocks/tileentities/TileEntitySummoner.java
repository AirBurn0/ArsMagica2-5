...
public class TileEntitySummoner extends TileEntityAMPower implements IInventory, IKeystoneLockable {
						...
						if(ent != null) {
							PowerNodeRegistry.For(this.worldObj)
											 .consumePower(this, PowerNodeRegistry.For(this.worldObj)
																				  .getHighestPowerType(this), maintainCost);
						}
					}
				}
				else {
	...
	public boolean canSummon() {
		...
		return summonCooldown == 0 && PowerNodeRegistry.For(this.worldObj)
													   .checkPower(this, getSummonCost() + powerPadding);
	}
	...
	private void summonCreature() {
		...
		if(summon != null) {
			...
			PowerNodeRegistry.For(this.worldObj)
							 .consumePower(this, PowerNodeRegistry.For(this.worldObj)
																  .getHighestPowerType(this), summonCost);
