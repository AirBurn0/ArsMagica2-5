...
public class TileEntityEverstone extends TileEntity {
	...
	public void setFacade(Block block, int meta) {
		...
		if(!worldObj.isRemote) {
			List<EntityPlayerMP> players = worldObj.getEntitiesWithinAABB(EntityPlayerMP.class, AxisAlignedBB.getBoundingBox(xCoord, yCoord, zCoord, xCoord + 1, yCoord + 1, zCoord + 1)
																											 .expand(64, 64, 64));
