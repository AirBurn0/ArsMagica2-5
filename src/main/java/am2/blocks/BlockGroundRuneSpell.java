...
public class BlockGroundRuneSpell extends BlockGroundRune {
	...
	private IIcon[] icons;
	private final String[] textureNames = {"rune_affinity_none", "rune_affinity_arcane", "rune_affinity_water", "rune_affinity_fire", "rune_affinity_earth", "rune_affinity_air", "rune_affinity_lightning", "rune_affinity_ice", "rune_affinity_plant", "rune_affinity_life", "rune_affinity_ender"};
